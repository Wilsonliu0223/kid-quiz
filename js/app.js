...
import { CONFIG } from "./config.site.js?v=config-v45.73";
import {
  loadZhItems,
  loadEnItems,
  uniqueLessons,
...
import { initEnWriting } from "./en-writing.js?v=en-writing-v13";
...
import { initGo, renderGoHomePlayers } from "./go.js?v=go-v7";
...
import { initEnDaily, openEnHub, onEnViewChange } from "./en-daily.js?v=en-daily-v86";
...
const views = {
  ...
  lifeHub: $("#view-life-hub"),
  lifeRead: $("#view-life-read"),
