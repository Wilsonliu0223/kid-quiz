...
agent --print --trust --force --sandbox disabled --approve-mcps --workspace "%CD%" --model cursor-grok-4.6-high -- "Read tools/daily-en-articles-prompt.txt and follow it exactly. Produce and upload today's five English articles now." >> "%LOG%" 2>&1
set "ERR=%ERRORLEVEL%"
